...
function makeDeviceManifest({ projectConfig, buildId, targetDevice, }) {
    ...
    return new stream_1.Transform({
        ...
        flush(done) {
            ...
            const { deviceApi } = sdkVersion_1.apiVersions(projectConfig);
            const supports = capabilities_1.SupportedDeviceCapabilities.create(targetDevice);
            const manifest = Object.assign(Object.assign(Object.assign(Object.assign({ appManifestVersion: 1, main: entryPoint, svgMain: resources.svgMain, svgWidgets: resources.svgWidgets, appType: projectConfig.appType }, makeCommonManifest({
                projectConfig,
                buildId,
                apiVersion: deviceApi,
            })), (supports && { supports })), { i18n: lodash_1.default.mapKeys(Object.assign({ [projectConfig.defaultLanguage]: defaultLanguage }, otherLocales), (_, locale) => locale.toLowerCase()) }), (projectConfig.appType !== ProjectConfiguration_1.AppType.CLOCKFACE && {
